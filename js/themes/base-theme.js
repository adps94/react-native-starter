...
export default {
  ...
  // Footer
  footerHeight: 56,
  footerDefaultBg: (Platform.OS === 'ios') ? '#353535' : '#353535',

  // FooterTab
  tabBarTextColor: (Platform.OS === 'ios') ? '#eee' : '#eee',
  tabBarActiveTextColor: (Platform.OS === 'ios') ? '#fff' : '#fff',
  tabActiveBgColor: (Platform.OS === 'ios') ? '#353535' : '#353535',

  // Header
  iosToolbarBtnColor: '#fff',
  toolbarDefaultBg: (Platform.OS === 'ios') ? '#353535' : '#353535',
  toolbarHeight: (Platform.OS === 'ios') ? 64 : 56,
  toolbarIconSize: (Platform.OS === 'ios') ? 22 : 22,
  ...
  iconFontSize: (Platform.OS === 'ios') ? 20 : 28,
  iconMargin: 10,
